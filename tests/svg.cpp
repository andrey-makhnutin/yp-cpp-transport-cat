...
void TestCircle() {
  ...
  TEST_RENDER(
      Circle().SetCenter( { 12.21, 34.43 }).SetRadius(56.65).SetFillColor(
          "test-fill-color"s).SetStrokeColor("test-stroke-color"s)
          .SetStrokeWidth(1.2).SetStrokeLineCap(StrokeLineCap::ROUND)
...
void TestPolyline() {
  ...
  TEST_RENDER(
      Polyline().AddPoint( { 12.34, 56.78 }).AddPoint( { 43.21, 87.65 })
          .SetFillColor("test-fill-color"s).SetStrokeColor("test-stroke-color"s)
          .SetStrokeWidth(1.2).SetStrokeLineCap(StrokeLineCap::ROUND)
          .SetStrokeLineJoin(StrokeLineJoin::MITER),
...
void TestText() {
  ...
  TEST_RENDER(
      Text().SetPosition( { 12.34, 56.78 }).SetData("hello text").SetOffset( {
          4.3, 2.1 }).SetFontSize(3).SetFontFamily("test-fam"s).SetFontWeight(
          "test-wei"s).SetFillColor("test-fill-color"s).SetStrokeColor(
          "test-stroke-color"s).SetStrokeWidth(1.2).SetStrokeLineCap(
          StrokeLineCap::ROUND).SetStrokeLineJoin(StrokeLineJoin::MITER),
