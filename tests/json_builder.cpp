...
void TestArray() {
  ASSERT_JSON_EQUAL(json::Builder{}.StartArray().Value(123).EndArray().Build(),
                    R"([123])"s);
  ASSERT_JSON_EQUAL(json::Builder{}
                        .StartArray()
                        .StartArray()
                        .Value(123)
                        .EndArray()
...
void TestPartial() {
  ...
  {
    auto arr_builder = json::Builder{}.StartArray();
    arr_builder.Value(json::Builder{}
                          .StartDict()
                          .Key("id"s)
                          .Value(1)
                          .EndDict()
    ...
    arr_builder.Value(json::Builder{}
                          ...
                          .Build()
                          .AsMap());
    ASSERT_JSON_EQUAL(arr_builder.EndArray().Build(),
                      R"([{"id":1},{"id":2}])"s);
  }
  {
